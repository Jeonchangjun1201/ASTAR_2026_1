...
namespace KSY.ClientCore.User
{
    ...
    {
        public PlayerData(UserData user, TeamType currentTeam = TeamType.None, int score = 0)
        {
            this._user = user;
        ...
        //플레이어의 팀
        public TeamType CurrentTeam { get; private set; } = TeamType.None; 
        ...
        //팀을 정하는 메서드
        public void SetTeam(TeamType type = TeamType.None) => CurrentTeam = type;
        //플레이어의 점수를 증가시키는 메서드
